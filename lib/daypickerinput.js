(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else root['DayPicker'] = factory(root['React'], root['moment']);
})(this, function(
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var DayPickerInput = (function(_React$Component) {
          ...
          function DayPickerInput(props) {
            ...
            var _this = _possibleConstructorReturn(
              this,
              (DayPickerInput.__proto__ ||
                Object.getPrototypeOf(DayPickerInput))
                .call(this, props)
            );
            ...
            _this.handleChange = function(e) {
              ...
              var day = m.toDate();
              _this.setState({ month: day, value: value });
              ...
              if (onDayChange) {
                ...
                var modifiers = (0, _ModifiersUtils.getModifiersForDay)(
                  day,
                  modifiersObj
                ).reduce(function(obj, modifier) {
            ...
            _this.handleDayClick = function(day, modifiers, e) {
              ...
              _this.setState(
                { value: m.format(_this.props.format), month: day },
